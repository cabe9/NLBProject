param(
    [string]$ConfigPath = "configs/benchmarks/mc_maze_stndt_lite_diverse_ensemble_screen.yaml",
...
$RunName = "stndt_lite_diverse_ensemble_screen"
...
$Stdout = Join-Path $OutDir "diverse_ensemble_$Stamp.out.log"
$Stderr = Join-Path $OutDir "diverse_ensemble_$Stamp.err.log"
$Status = Join-Path $OutDir "diverse_ensemble_status_$Stamp.txt"
$PidPath = Join-Path $OutDir "diverse_ensemble.pid"
