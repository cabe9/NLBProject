param(
    [string]$ConfigPath = "configs/benchmarks/mc_maze_stndt_lite_diverse_screen_o_width224_refinement.yaml",
...
$RunName = "stndt_lite_diverse_screen_o_width224_refinement"
...
$Stdout = Join-Path $OutDir "width224_refinement_$Stamp.out.log"
$Stderr = Join-Path $OutDir "width224_refinement_$Stamp.err.log"
$Status = Join-Path $OutDir "width224_refinement_status_$Stamp.txt"
$PidPath = Join-Path $OutDir "width224_refinement.pid"
